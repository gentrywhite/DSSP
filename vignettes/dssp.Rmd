...
# TODO check why the pred.data are almost zero for all cases?
# I used colMeans above instead of rowMeans but maybe that's not correct? it's rowMeans here and colMeans is the wrong dimensions
