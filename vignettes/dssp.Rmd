...
\]
Note that the matrix $\mathbf{M}$ is based on thin-plate spline basis functions subject to boundary conditions. The details are ommitted here for clarity and to focus on the results and implementation in package. 
